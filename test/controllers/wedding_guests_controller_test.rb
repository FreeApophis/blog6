...
class WeddingGuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wedding_guest" do
    assert_difference('WeddingGuest.count') do
      post wedding_guests_url, params: { wedding_guest: { name: @wedding_guest.name, user_id: @wedding_guest.user_id } }
    end
  ...
  test "should update wedding_guest" do
    patch wedding_guest_url(@wedding_guest), params: { wedding_guest: { name: @wedding_guest.name, user_id: @wedding_guest.user_id } }
